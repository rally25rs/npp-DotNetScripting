...
{
    public class CSharpProgramRunner
    {
        ...
        public CSharpProgramRunner(NppCommands nppCommands, string scriptBefore, string scriptLine, string scriptAfter)
        {
        ...
        public string RunLine(string line)
        {
            ...
            scriptEngine.Execute("var _ = GetLine();", scriptEngineSession);
